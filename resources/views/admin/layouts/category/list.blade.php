            ...
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a class="btn btn-added" data-bs-toggle="modal" data-bs-target="#addpayment"><img
                            src="{{ asset('admin/img/icons/plus.svg') }}" alt="img" class="me-1">Add New Category</a>
                </div>
            </div>
                            ...
                            <tbody>
                                @foreach ($items as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td>
                                        <td class="text-end">
                                            <a class="me-3" href="{{ route('category.editPage', $item->id) }}">
                                                <img src="{{ asset('admin/img/icons/edit.svg') }}" alt="img">
                                            </a>
                                            <a class="me-3 confirm-text" href="{{ route('category.delete', $item->id) }}">
